    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">
          {language === 'en' ? 'Sign in to your account' : 'Přihlaste se do svého účtu'}
        </h2>
        <p className="mt-2 text-center text-sm text-gray-600">
          {language === 'en' ? 'Welcome back! Please sign in to continue' : 'Vítejte zpět! Prosím, přihlaste se'}
        </p>
      </div>
        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="mt-1 relative">
                ...
                <input
                  ...
                  placeholder={language === 'en' ? 'Enter your password' : 'Zadejte heslo'}
                />
                <button
                  type="button"
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <label htmlFor="rememberMe" className="ml-2 block text-sm text-gray-900">
                  {language === 'en' ? 'Remember me' : 'Zapamatovat si mě'}
                </label>
              </div>

              <div className="text-sm">
                <Link href="/auth/forgot-password" className="font-medium text-blue-600 hover:text-blue-500">
                  {language === 'en' ? 'Forgot your password?' : 'Zapomněli jste heslo?'}
                </Link>
              </div>
            </div>
            ...
            <div>
              ...
              >
                {isLoading 
                  ? (language === 'en' ? 'Signing In...' : 'Přihlašujeme...') 
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-white text-gray-500">
                    {language === 'en' ? 'Or continue with' : 'Nebo pokračujte s'}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="text-center">
              <p className="text-sm text-gray-600">
                ...
                <Link href="/auth/register" className="font-medium text-blue-600 hover:text-blue-500">
                  {language === 'en' ? 'Create one' : 'Vytvořte si jej'}
                </Link>
              </p>
            </div>
          </form>
